                ...
                <div class='card'>
                    <div class='card-body'>
                        ...
                        <div class='row'>
                            <div class='col-md-12'>
                                <?php
                                    echo "<form action='/Graduation-Project-Management/teacher/profile/update' method='post' enctype='multipart/form-data'>
                                    <div class='form-group row'>
                                        <label for='email' class='col-4 col-form-label'>Email</label>
                                        <div class='col-8'>
                                            <input id='email' name='email' class='form-control here' required type='text' value='".$data['teacher']['email']."'>
                                        </div>
                                    </div>
                                    <div class='form-group row'>
                                        <label for='name' class='col-4 col-form-label'>Full Name</label>
                                        <div class='col-8'>
                                            <input id='name' name='name' class='form-control here' required type='text' value='".$data['teacher']['name']."'>
                                        </div>
                                    </div>
                                    <div class='form-group row'>
                                        <label for='phone' class='col-4 col-form-label'>Phone</label>
                                        <div class='col-8'>
                                            <input id='phone' name='phone' class='form-control here' pattern='(09|03|07|08|05)+([0-9]{8})\b' required type='text' value='".$data['teacher']['phone']."'>
                                        </div>
                                    </div>
                                        ...
                                        <div class='col-8'>
                                            <select id='select' name='branch' class='custom-select'>";
                                                foreach ($data['branches'] as $branch) {
                                                    if($branch['id'] == $data['teacher']['branch']){
                                    ...
                                    <div class='form-group row'>
                                        <label for='work_place' class='col-4 col-form-label'>Work Place</label>
                                        <div class='col-8'>
                                            <input id='work_place' name='work_place' class='form-control here' type='text' value='".$data['teacher']['work_place']."'>
                                        </div>
                                    </div>
                                    <div class='form-group row'>
                                        <label for='degree' class='col-4 col-form-label'>Degree</label>
                                        <div class='col-8'>
                                            <input id='degree' name='degree' class='form-control here' type='text' value='".$data['teacher']['degree']."'>
                                        </div>
                                    </div>
                                    <div class='form-group row'>
                                        <label for='academic_rank' class='col-4 col-form-label'>Academic Rank</label>
                                        <div class='col-8'>
                                            <input id='academic_rank' name='academic_rank' class='form-control here' type='text' value='".$data['teacher']['academic_rank']."'>
                                        </div>
                                    </div>
                                    <div class='form-group row'>
