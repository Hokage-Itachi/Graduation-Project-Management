            ...
            <nav class="col-md-2 d-none d-md-block bg-light sidebar">
                <div class="sidebar-sticky">
                    <ul class="nav flex-column">
                        <li class="nav-item">
                            <a class="nav-link active" href="/Graduation-Project-Management/admin">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-sm-36 col-md-5 col-lg-4 col-xl-3 mb-3">
                            <div class="card text-center bg-light">
                                <div class="card-body">
                                    <?php echo "<h5 class='card-title'>" . $data['dashboard']['student_number'] . "</h5>"; ?>
                                    <h6 class="card-subtitle mb-2 text-muted">Students</h6>
                                    <p class="card-text">All is learning online now because of N.Covi 19</p>
                                    <a href="/Graduation-Project-Management/admin/students" class="card-link">Details</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-36 col-md-5 col-lg-4 col-xl-3 mb-3">
                            <div class="card text-center bg-info">
                                <div class="card-body">
                                    <?php echo "<h5 class='card-title'>" . $data['dashboard']['teacher_number'] . "</h5>"; ?>
                                    <h6 class="card-subtitle mb-2 text-muted">Teachers</h6>
                                    <p class="card-text">All is masters, doctors, professors</p>
                                    <a href="/Graduation-Project-Management/admin/teachers" class="card-link">Details</a>
                                </div>
                            </div>
                        </div>
                        <div class="col-sm-36 col-md-5 col-lg-4 col-xl-3 mb-3">
                            <div class="card text-center bg-warning">
                                <div class="card-body">
                                    ...
                                    <a href="/Graduation-Project-Management/admin/projects" class="card-link">Details</a>
                                </div>
                            </div>
                        </div>
                    </div>
