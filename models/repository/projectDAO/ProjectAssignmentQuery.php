...
class ProjectAssignmentQuery{
    ...
    const INSERT = "INSERT INTO project_assignment (project_id, student_id, teacher_id) VALUE ('%s', '%s', '%s')";
    const SELECT_PROJECT_ASSIGNMENT = "SELECT * FROM project_assignment";
	const INSERT_PROJECT_ASSIGNMENT = "INSERT INTO project_assignment(project_id,student_id,teacher_id,day of protection) VALUES ('%s','%s','%s','%s')";
