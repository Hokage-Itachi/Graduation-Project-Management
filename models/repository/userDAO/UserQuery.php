...
class UserQuery 
{
	...
	//commment
	const SELECT_COMMENT = "SELECT * FROM comment WHERE '%s'";
	const INSERT_COMMENT = "INSERT INTO comment(id, content, created_at, post_id, user_id) VALUES ('%s','%s','%s','%s','%s')";
	const UPDATE_COMMENT = "UPDATE comment SET id='%s',content='%s',created_at='%s',post_id='%s',user_id='%s' WHERE '%s'";
	const DELETE_COMMENT = "DELETE FROM comment WHERE '%s'";
	//branch
	const SELECT_BRANCH = "SELECT * FROM branch WHERE '%s'";
	const INSERT_BRANCH = "INSERT INTO branch(id, name) VALUES ('%s','%s')";
	const UPDATE_PHASE =  "UPDATE branch SET id = '%s' ,name = '%s' WHERE '%s'";
	const DELETE_PHASE =  "DELETE FROM branch WHERE '%s'";
